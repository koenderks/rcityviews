...
You can select different themes for the plot. The images above are created using `theme = "original"`, but other options for the `theme` argument include `light` (top left), `dark` (top middle), `rouge` (top right), `colored` (bottom left), `neon` (bottom middle), and `X` (bottom right).
...
<p align="center">
  ...
  <img src='https://github.com/koenderks/rcityviews/raw/master/png/Amsterdam_X.png' width='250' height='250'>
</p>
