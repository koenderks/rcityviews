...
First, let's look at the center of Amsterdam. This location is not featured in
the internal database, which means that you will need to create a new city
instance using the `new_city()` function.
...
which is why `name` is specified as `"Centrum, Amsterdam"` in the code above.
