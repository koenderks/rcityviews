...
is to show you how you can use this this package to create pretty images of the
...
```{r, echo = FALSE}
knitr::include_graphics("https://github.com/koenderks/rcityviews/raw/master/png/Amsterdam.jpg")
```
...
```
```{r, echo = FALSE}
knitr::include_graphics("https://github.com/koenderks/rcityviews/raw/master/png/Amsterdam.png")
```
...
```
```{r, echo = FALSE}
knitr::include_graphics("https://github.com/koenderks/rcityviews/raw/master/png/Amsterdam2.png")
```
...
```
```{r, echo = FALSE}
knitr::include_graphics("https://github.com/koenderks/rcityviews/raw/master/png/AmsterdamCenter.png")
```
...
```
```{r, echo = FALSE}
knitr::include_graphics("https://github.com/koenderks/rcityviews/raw/master/png/AmsterdamEast.png")
```
...
```
```{r, echo = FALSE}
knitr::include_graphics("https://github.com/koenderks/rcityviews/raw/master/png/AmsterdamSouth.png")
```
...
```
```{r, echo = FALSE}
knitr::include_graphics("https://github.com/koenderks/rcityviews/raw/master/png/AmsterdamWest.png")
```
...
```
```{r, echo = FALSE}
knitr::include_graphics("https://github.com/koenderks/rcityviews/raw/master/png/AmsterdamNorth.png")
```
