...
.onLoad <- function(libname, pkgname) {
  ...
  # Set overpass url
  osmdata::set_overpass_url("https://overpass-api.de/api/interpreter") # default: https://overpass-api.de/api/interpreter, fallback: https://overpass.private.coffee/api/interpreter
