...
.shiny_ui <- shiny::fluidPage(
  ...
  shiny::fluidRow(
    ...
    shiny::column(3,
      ...
      shiny::fluidRow(
        align = "center",
        shiny::column(width = 6, shiny::selectInput(inputId = "theme", label = "Theme", choices = c("Original", "Light", "Dark", "Colored", "Rouge", "Verde", "Neon", "Atlantis", "Vintage", "Lichtenstein"))),
      ...
      shiny::fluidRow(
        ...
        shiny::column(width = 6, shiny::sliderInput(inputId = "places", label = "No. Places", value = 0, min = 0, max = 20, step = 1, ticks = FALSE))
      ),
      shiny::fluidRow(
        align = "center",
